...
public class AgeCalculator
{
	public static void main(String[] args)
	{
		...
		birthYear = Integer.parseInt(JOptionPane.showInputDialog(null,"In what year were you born?")); //Ask the user to input their birthYear
	    ...
	    JOptionPane.showMessageDialog(null,"This is the year you become " + yearsOld + " years old");//Outputs to the user how old they are
	}
}